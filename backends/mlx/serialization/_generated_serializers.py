...
class GeneratedOpBuilders:
    ...
    def _build_BitwiseInvertNode(
        self, builder: flatbuffers.Builder, op: BitwiseInvertNode
    ) -> Tuple[int, int]:
        """Auto-generated builder for BitwiseInvertNode."""
        # Import the MODULE (not class) to access builder functions like Start(), Add*(), End()
        from executorch.backends.mlx.serialization._generated.mlx_delegate import BitwiseInvertNode as FBBitwiseInvertNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate import OpNode as FBOpNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Tid import CreateTid
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Vid import CreateVid

        FBBitwiseInvertNodeModule.Start(builder)
        FBBitwiseInvertNodeModule.AddX(builder, CreateTid(builder, op.x.idx))
        FBBitwiseInvertNodeModule.AddOut(builder, CreateTid(builder, op.out.idx))
        offset = FBBitwiseInvertNodeModule.End(builder)
        return offset, FBOpNodeModule.OpNode.BitwiseInvertNode
    ...
    def _build_BitwiseAndNode(
        self, builder: flatbuffers.Builder, op: BitwiseAndNode
    ) -> Tuple[int, int]:
        """Auto-generated builder for BitwiseAndNode."""
        # Import the MODULE (not class) to access builder functions like Start(), Add*(), End()
        from executorch.backends.mlx.serialization._generated.mlx_delegate import BitwiseAndNode as FBBitwiseAndNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate import OpNode as FBOpNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Tid import CreateTid
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Vid import CreateVid

        FBBitwiseAndNodeModule.Start(builder)
        FBBitwiseAndNodeModule.AddA(builder, CreateTid(builder, op.a.idx))
        FBBitwiseAndNodeModule.AddB(builder, CreateTid(builder, op.b.idx))
        FBBitwiseAndNodeModule.AddOut(builder, CreateTid(builder, op.out.idx))
        offset = FBBitwiseAndNodeModule.End(builder)
        return offset, FBOpNodeModule.OpNode.BitwiseAndNode
    ...
    def _build_RollNode(
        self, builder: flatbuffers.Builder, op: RollNode
    ) -> Tuple[int, int]:
        """Auto-generated builder for RollNode."""
        # Import the MODULE (not class) to access builder functions like Start(), Add*(), End()
        from executorch.backends.mlx.serialization._generated.mlx_delegate import RollNode as FBRollNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate import OpNode as FBOpNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Tid import CreateTid
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Vid import CreateVid

        shift_vec = self._build_int_or_vid_vector(builder, op.shift)
        axes_vec = _build_int_vector(builder, op.axes)

        FBRollNodeModule.Start(builder)
        FBRollNodeModule.AddX(builder, CreateTid(builder, op.x.idx))
        FBRollNodeModule.AddOut(builder, CreateTid(builder, op.out.idx))
        FBRollNodeModule.AddShift(builder, shift_vec)
        FBRollNodeModule.AddAxes(builder, axes_vec)
        offset = FBRollNodeModule.End(builder)
        return offset, FBOpNodeModule.OpNode.RollNode
