...
@dataclass
class MetalKernelNode:
    name: str
    source: str
    inputs: List[Tid]
    outputs: List[Tid]
    grid: List[IntOrVid]
    threadgroup: List[IntOrVid]
    ...
    output_shapes_flat: Optional[List[IntOrVid]] = None
    output_shape_lengths: Optional[List[int]] = None
    output_dtypes: Optional[List[int]] = None
    template_arg_names: Optional[List[str]] = None
    template_arg_kinds: Optional[List[int]] = None
    template_arg_values: Optional[List[int]] = None
